...
public class CameraRental {
	...
	class CameraRentalSystem {
	    ...
	    private void displayWelcomeScreen() {
	        ...
	        System.out.println("Developed by: Aradhana Kumari\n");
	    ...
	    private void login() {
	        ...
	        // For simplicity, we assume a single hardcoded valid username and password
	        if (username.equals("Aradhana") && password.equals("Apdp@0716")) {
